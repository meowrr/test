...
以/开始的相对路径，找资源，以 服务器的路径为标准（http://localhost:3306)需要加上项目名
...
<body>
	...
	<script type="text/javascript">
		...
		//1、页面加载完成以后，直接去发送一个ajax的请求，要到分页数据
		$(function() {
			//去首页
			to_page(1);
		});
		...
		function getDepts(ele) {
			...
			$.ajax({
				...
				success : function(result) {
					//console.log(result);
					//显示部门信息在下拉列表中,不用id找
					//code:100extend:depts:Array(2)0:{deptId: 1, deptName: "开发部"}1:deptId:2deptName:"测试部"
		...
		function getEmp(id) {
			$.ajax({
				...
				success : function(result) {
					//console.log();
					//extend:{emp: {empId: 1, empName: "Jerry", gender: "M", email: "Jerry@ssm.com", dId: 1, department: null}}
					//msg:"处理成功"
